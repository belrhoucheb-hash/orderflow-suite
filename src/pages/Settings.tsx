  ...
  return (
    <div className="flex flex-col gap-6 h-full pb-12">
      ...
      >
        ...
        {/* Sidebar-navigatie */}
        <aside className="w-56 shrink-0 border-r border-[hsl(var(--gold)/0.1)] pr-4 py-1 overflow-y-auto">
                  ...
                  {group.items.map((item) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          "w-full text-left px-3 py-2 rounded-lg text-[13px] transition-colors relative",
                          active
                            ? "bg-[hsl(var(--gold-soft)/0.38)] text-[hsl(var(--gold-deep))] font-medium"
                            : "text-muted-foreground hover:bg-[hsl(var(--gold-soft)/0.16)] hover:text-foreground"
                        )}
                      >
                        {active && (
                          <span className="absolute left-0 top-2 bottom-2 w-0.5 rounded-full bg-[hsl(var(--gold-deep))]" aria-hidden="true" />
                        )}
                        {item.label}
                      </button>
                    );
        ...
        <TabsContent value="algemeen" className="space-y-6 outline-none">
          <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px]">
            ...
            <div className="space-y-4">
              <div className="card--luxe p-5 md:p-6 space-y-4">
                <div>
                  <p className="text-[11px] font-display font-semibold text-[hsl(var(--gold-deep))] uppercase tracking-[0.16em]">
                    Aandacht nodig
                  </p>
                ...
                {attentionItems.length === 0 ? (
                  <div className="rounded-2xl border border-[hsl(var(--gold)/0.14)] bg-[hsl(var(--gold-soft)/0.12)] px-4 py-4">
