          ...
          <div className="mx-auto grid max-w-[1120px] gap-6 px-6 pb-10 pt-4 lg:grid-cols-[minmax(0,1fr)_340px]">
            ...
            {wizardStep === "intake" && (
              <IntakeSection
                ...
                setClientQuestionConfirmed={setClientQuestionConfirmed}
                clientOpen={clientOpen}
                setClientOpen={setClientOpen}
                clientListOpen={clientListOpen}
                clientListToggleUntilRef={clientListToggleUntilRef}
                clientSuggestions={clientSuggestions}
                selectedClient={selectedClient}
                clientLocations={clientLocations}
                warehouses={warehouses}
                clientAnswered={clientAnswered}
                clientInputReady={clientInputReady}
                clientNeedsConfirmation={clientNeedsConfirmation}
                missingClient={missingClient}
                contactpersoon={contactpersoon}
                setContactpersoon={setContactpersoon}
                contactChoiceMode={contactChoiceMode}
                setContactChoiceMode={setContactChoiceMode}
                ...
                setManualContactEmail={setManualContactEmail}
                manualContactPhone={manualContactPhone}
                setManualContactPhone={setManualContactPhone}
                activeClientContacts={activeClientContacts}
                contactAnswered={contactAnswered}
                contactRoleLabel={contactRoleLabel}
                klantReferentie={klantReferentie}
                setKlantReferentie={setKlantReferentie}
                transportFlowChoice={transportFlowChoice}
                chooseTransportFlow={chooseTransportFlow}
                afdeling={afdeling}
                errors={errors}
                setErrors={setErrors}
                ...
                flowInputClass={flowInputClass}
                requiredFieldClass={requiredFieldClass}
                requiredTextClass={requiredTextClass}
            ...
            {wizardStep === "route" && (
              <RouteSection
                ...
                routeRuleIssues={routeRuleIssues}
                pickupLine={pickupLine}
                deliveryLine={deliveryLine}
                extraDeliveryLines={extraDeliveryLines}
                deliveryStops={deliveryStops}
                primaryLadenId={primaryLadenId}
                primaryLossenId={primaryLossenId}
                isMultiLegRoute={isMultiLegRoute}
                pickupQuickOptions={pickupQuickOptions}
                deliveryQuickOptions={deliveryQuickOptions}
                pickupAddr={pickupAddr}
                deliveryAddr={deliveryAddr}
                setPickupLookup={setPickupLookup}
                setDeliveryLookup={setDeliveryLookup}
                setPickupAddressBookLabel={setPickupAddressBookLabel}
                setDeliveryAddressBookLabel={setDeliveryAddressBookLabel}
                errors={errors}
                setErrors={setErrors}
                clearError={clearError}
                ...
                missingDeliveryTimeWindow={missingDeliveryTimeWindow}
                pickupRouteIssue={pickupRouteIssue}
                primaryDeliveryRouteIssue={primaryDeliveryRouteIssue}
                allowOutsideBusinessHours={allowOutsideBusinessHours}
                setAllowOutsideBusinessHours={setAllowOutsideBusinessHours}
                handlePickupAddrChange={handlePickupAddrChange}
                handlePickupAddrBlur={handlePickupAddrBlur}
                handleDeliveryAddrChange={handleDeliveryAddrChange}
                handleDeliveryAddrBlur={handleDeliveryAddrBlur}
                applyPlannerLocation={applyPlannerLocation}
                maybeLearnClientAlias={maybeLearnClientAlias}
                addFreightLine={addFreightLine}
                removeFreightLine={removeFreightLine}
                updateFreightLine={updateFreightLine}
                updateFreightLineAddress={updateFreightLineAddress}
                setFreightLines={setFreightLines}
                locationDisplay={locationDisplay}
                getDeliveryStopLabel={getDeliveryStopLabel}
                uberFlowShellClass={uberFlowShellClass}
                conversationalCardClass={conversationalCardClass}
                flowLabelClass={flowLabelClass}
                flowInputClass={flowInputClass}
                ...
                renderCollapsedAnswer={renderCollapsedAnswer}
                renderQuestionPrompt={renderQuestionPrompt}
                renderLocationOperationalDetails={renderLocationOperationalDetails}
                renderWizardFooter={renderWizardFooter}
              />
            )}
            ...
            {wizardStep === "cargo" && (
              <CargoSection
                ...
                cargoSameDimensions={cargoSameDimensions}
                setCargoSameDimensions={setCargoSameDimensions}
                setCargoManualBack={setCargoManualBack}
                cargoHasDimensions={cargoHasDimensions}
                updateCargoRow={updateCargoRow}
                clearError={clearError}
                ...
                requiredTextClass={requiredTextClass}
                setWizardStep={setWizardStep}
                transportEenheid={transportEenheid}
                uberFlowShellClass={uberFlowShellClass}
                conversationalCardClass={conversationalCardClass}
                flowLabelClass={flowLabelClass}
                flowInputClass={flowInputClass}
                renderUberStepHeader={renderUberStepHeader}
                renderCollapsedFacts={renderCollapsedFacts}
                renderQuestionPrompt={renderQuestionPrompt}
                renderWizardFooter={renderWizardFooter}
              />
            )}
