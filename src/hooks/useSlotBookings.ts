...
export function useCreateSlotBooking() {
  ...
  return useMutation({
    ...
    onSuccess: (_data: SlotBooking, variables: Omit<SlotBooking, "id" | "created_at" | "updated_at" | "order" | "location">) => {
...
export function useCancelSlotBooking() {
  ...
  return useMutation({
    ...
    onSuccess: (_data: unknown, variables: { id: string; locationId: string; date: string }) => {
