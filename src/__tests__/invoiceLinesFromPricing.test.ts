...
describe("generateInvoiceLinesFromPricing", () => {
  it("converts price breakdown into invoice lines", () => {
    const breakdown: PriceBreakdown = {
      basisbedrag: 250,
      toeslagen: [{ name: "Dieseltoeslag", type: "PERCENTAGE", amount: 31.25 }],
      totaal: 281.25,
      regels: [{ description: "PER_KM 135 km x EUR 1.85", quantity: 135, unit: "km", unit_price: 1.85, total: 249.75, rule_type: "PER_KM" }],
    };
  ...
  it("handles breakdown with no surcharges", () => {
    const breakdown: PriceBreakdown = {
      basisbedrag: 400, toeslagen: [], totaal: 400,
      regels: [{ description: "Vast bedrag", quantity: 1, unit: "rit", unit_price: 400, total: 400, rule_type: "VAST_BEDRAG" }],
    };
  ...
  it("handles empty breakdown", () => {
    const breakdown: PriceBreakdown = { basisbedrag: 0, toeslagen: [], totaal: 0, regels: [] };
  ...
  it("sets sort_order incrementally", () => {
    const breakdown: PriceBreakdown = {
      basisbedrag: 300,
      toeslagen: [{ name: "ADR", type: "VAST_BEDRAG", amount: 50 }, { name: "Weekend", type: "PERCENTAGE", amount: 75 }],
      totaal: 425,
      regels: [{ description: "Transport", quantity: 1, unit: "rit", unit_price: 300, total: 300, rule_type: "VAST_BEDRAG" }],
    };
