            ...
            <Table>
              <TableHeader className="bg-muted/30">
                <TableRow className="hover:bg-transparent">
                  <TableHead className="w-[200px] text-[11px] uppercase tracking-wider font-semibold">Naam</TableHead>
                  <TableHead className="text-[11px] uppercase tracking-wider font-semibold">Code</TableHead>
                  <TableHead className="text-[11px] uppercase tracking-wider font-semibold">Capaciteit (kg)</TableHead>
                  <TableHead className="text-[11px] uppercase tracking-wider font-semibold">Capaciteit (plt)</TableHead>
              ...
              <TableBody>
                ...
                {vehicleTypes.map((vt) => (
                  <TableRow key={vt.id} className="group transition-colors">
                    ...
                    <TableCell><code className="text-[10px] bg-muted px-1.5 py-0.5 rounded text-muted-foreground">{vt.code}</code></TableCell>
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between px-1">
          ...
          <Button size="sm" variant="outline" className="h-8 gap-1.5 rounded-lg border-dashed border-2 hover:border-amber-600/30 hover:bg-amber-50" onClick={() => setIsAdding('unit')}>
            <Plus className="h-3.5 w-3.5 text-amber-600" />Toevoegen
          </Button>
        </div>
            ...
            <Table>
              <TableHeader className="bg-muted/30">
                <TableRow className="hover:bg-transparent">
                  <TableHead className="w-[200px] text-[11px] uppercase tracking-wider font-semibold">Naam</TableHead>
                  <TableHead className="text-[11px] uppercase tracking-wider font-semibold">Code</TableHead>
                  <TableHead className="text-[11px] uppercase tracking-wider font-semibold">Standaard Gewicht</TableHead>
                  <TableHead className="text-[11px] uppercase tracking-wider font-semibold">Afmetingen</TableHead>
                  <TableHead className="w-[100px]"></TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                ...
                {loadingUnits.map((lu) => (
                  <TableRow key={lu.id} className="group transition-colors">
                    ...
                    <TableCell><code className="text-[10px] bg-muted px-1.5 py-0.5 rounded text-muted-foreground">{lu.code}</code></TableCell>
        ...
        <div className="flex items-center justify-between px-1">
          <div className="flex items-center gap-3">
             <div className="h-9 w-9 rounded-xl bg-purple-500/10 flex items-center justify-center">
               <AlertTriangle className="h-4.5 w-4.5 text-purple-600" />
             </div>
             <div>
          ...
          <Button size="sm" variant="outline" className="h-8 gap-1.5 rounded-lg border-dashed border-2 hover:border-purple-600/30 hover:bg-purple-50" onClick={() => setIsAdding('requirement')}>
            <Plus className="h-3.5 w-3.5 text-purple-600" />Toevoegen
          </Button>
        </div>
            ...
            <Table>
              <TableHeader className="bg-muted/30">
                <TableRow className="hover:bg-transparent">
                  <TableHead className="w-[200px] text-[11px] uppercase tracking-wider font-semibold">Naam</TableHead>
                  <TableHead className="text-[11px] uppercase tracking-wider font-semibold">Code</TableHead>
                  <TableHead className="text-[11px] uppercase tracking-wider font-semibold">Categorie</TableHead>
                  <TableHead className="text-[11px] uppercase tracking-wider font-semibold">Kleur</TableHead>
                  <TableHead className="w-[100px]"></TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                ...
                {requirementTypes.map((rt) => (
                  <TableRow key={rt.id} className="group transition-colors">
                    ...
                    <TableCell><code className="text-[10px] bg-muted px-1.5 py-0.5 rounded text-muted-foreground">{rt.code}</code></TableCell>
                    <TableCell className="text-[10px] text-muted-foreground uppercase font-medium">{rt.category}</TableCell>
                    <TableCell className="text-[10px] font-mono text-muted-foreground uppercase">{rt.color || "—"}</TableCell>
                    <TableCell>
