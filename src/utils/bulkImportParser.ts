...
/** Excel import is tijdelijk uitgeschakeld. Gebruik CSV/TXT voor bulk import. */
export function parseExcel(_buffer: ArrayBuffer): never {
  throw new Error("Excel-import is tijdelijk uitgeschakeld. Gebruik een CSV-bestand.");
}
