...
export const COST_CATEGORIES: CostCategory[] = [
  "BRANDSTOF", "TOL", "CHAUFFEUR", "VOERTUIG", "OVERIG",
];

export const COST_CATEGORY_LABELS: Record<CostCategory, string> = {
  BRANDSTOF: "Brandstof",
  TOL: "Tolkosten",
  CHAUFFEUR: "Chauffeurkosten",
  VOERTUIG: "Voertuigkosten",
  OVERIG: "Overig",
};
...
export const CALCULATION_METHODS: CalculationMethod[] = [
  "PER_KM", "PER_UUR", "PER_RIT", "PER_STOP", "HANDMATIG",
];
